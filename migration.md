...
**1 June 2023**: The location setting in {{site.data.keyword.compliance_short}} will be frozen. The location that is set in the service is the region in which your new instance will be created.

**30 June 2023**: A regional instance of {{site.data.keyword.compliance_short}} will be available in your account based on your set location and the global instance will be removed. The new instances will not have the collector-based functionality. Additionally, the changes to IAM and CBR policies will take effect.

You might see two instances of {{site.data.keyword.compliance_short}} through the Billing UI during the migration period although you can’t see two instances in your account. This is due to the way that the migration is being conducted. You are only billed through one. When the migration is complete, the global instance will be removed from your account.
{: tip}
