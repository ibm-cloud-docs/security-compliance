...
To store and process your data in the EU, select **European Union** as your location on the **Global settings** page in the {{site.data.keyword.compliance_short}} UI.
{: note}
