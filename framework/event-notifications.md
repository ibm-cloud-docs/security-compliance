...
Before you can send a test {{site.data.keyword.compliance_short}} events, you must have topics, destinations, and subscriptions created in your {{site.data.keyword.en_short}} instance. For more information, see the [{{site.data.keyword.en_short}} documentation](/docs/event-notifications?topic=event-notifications-en-create-en-topic).
{: note}
...
Before you can send a test {{site.data.keyword.compliance_short}} event, you must have [topics, destinations, and subscriptions](/docs/event-notifications?topic=event-notifications-en-create-en-topic) created in your {{site.data.keyword.en_short}} instance.
{: note}
