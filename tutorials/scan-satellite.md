...
6. Create an attachment between your scope and profile by scheduling a scan. 
   ...
   3. From the **Profile** drop-down, select the profile that you want to use to evaluate your configuration.
      ...
      If your scope includes Financial Cloud Validated services only, then select the latest version of the {{site.data.keyword.cloud_notm}} for Financial Services profile. You can also choose to create a [custom profile](/docs/security-compliance?topic=security-compliance-custom-profiles) that that contains the specifc subset of goals from a profile that you want to evaluate your resources for. 
      {: note}
