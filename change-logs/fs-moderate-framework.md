...
|:--------|:----------------|:--------------------|:-------|
| `rule-ab4301de-c43b-489f-ba0a-2ced0080ba8f`	| Check whether IBM Log Analysis instance log retention is set to at least # days |	`AC-2(g)`, `AC-2(4)`, `AC-2(7)(b)`, `AC-6(9)`, `AU-2(a)`, `AU-2(d)`, `AU-3`, `AU-8(a)`, `AU-8(b)`, `AU-8(1)(a)`, `AU-8(1)(b)`, `AU-12(a)`, `AU-12(b)`, `AU-12(c)`, `CA-7(d)`, `SI-4(a)`, `SI-4(b)`, and `SI-4(c)` | The rule is removed. |
| `rule-c98fab05-5119-451a-b100-35df840d2326`	| Check whether IBM Activity Tracker logs are encrypted at rest |	`SC-13`, `SC-28`, and `SC-28(1)` | The rule is removed. |
| `rule-ba79b984-ec18-4fc1-965d-82cf701eb94f`	| Check whether an instance of IBM Log Analysis exists in each required region and is configured to receive platform logs |	`AC-4` | The rule is removed. |
| `rule-2aa7888e-ed67-40f3-9bff-8a70fddb4671`	| Check whether IBM Log Analysis can be accessed only through a private endpoint (Context-based restrictions or service) and allowed IPs with MFA enabled or not |	`AC-4(0)`, `CM-7(a)`, `CM-7(b)`, `SC-7(a)`, `SC-7(b)`, `SC-7(4)(a)`, and `SC-7(5)` | The rule is removed. |
| `rule-14808a2d-ab9b-4333-8275-f12559620cbb`	| Check whether there are no wild cards and wide flows in the private and public endpoints allow list for IBM Log Analysis (Context-based restrictions or service) |	`AC-4(0)`, `CM-7(a)`, `CM-7(b)`, `SC-7(a)`, `SC-7(b)`, `SC-7(4)(a)`, and `SC-7(5)` | The rule is removed. |
| `rule-d592e06a-8756-4efc-a401-1ec215168f48`	| Check whether IBM Activity Tracker trails are integrated with LogDNA logs |	`AC-2(g)`, `AC-2(4)`, `AC-2(7)(b)`, `AC-6(9)`, `AU-2(a)`, `AU-2(d)`, `AU-3`, `AU-8(a)`, `AU-8(b)`, `AU-8(1)(a)`, `AU-8(1)(b)`, `AU-12(a)`, `AU-12(b)`, `AU-12©`, `CA-7(d)`, `SI-4(a)`, `SI-4(b)`, and `SI-4(c)` | The rule is removed. |
| `rule-2f84317e-83b3-451d-bb95-9bd4ba953bdf`	| Check that there is an Activity Tracker hosted event search defined in each region to collect location-based events |	`AC-2(g)`, `AC-2(4)`, `AC-2(7)(b)`, `AC-6(9)`, `AU-2(a)`, `AU-2(d)`, `AU-3`, `AU-8(a)`, `AU-8(b)`, `AU-8(1)(a)`, `AU-8(1)(b)`, `AU-12(a)`, `AU-12(b)`, `AU-12©`, `CA-7(d)`, `SI-4(a)`, `SI-4(b)`, and `SI-4(c)` | The rule is removed. |
| `rule-84a0c7b9-cb37-430b-8a6d-afafb384ed9b`	| Check that Activity Tracker hosted Event Search is configured to collect global events generated by IBM Cloud services |	`AC-2(g)`, `AC-2(4)`, `AC-2(7)(b)`, `AC-6(9)`, `AU-2(a)`, `AU-2(d)`, `AU-3`, `AU-8(a)`, `AU-8(b)`, `AU-8(1)(a)`, `AU-8(1)(b)`, `AU-12(a)`, `AU-12(b)`, `AU-12©`, `CA-7(d)`, `SI-4(a)`, `SI-4(b)`, and `SI-4(c)` | The rule is removed. |
...
| `rule-911a3948-f5af-4d91-b329-5c71c1ebf8c2`	| Check whether an IBM Cloud Activity Tracker instance is available across all provisioned resource regions |	`AC-2(g)`, `AC-2(4)`, `AC-2(7)(b)`, `AC-6(9)`, `AU-2(a)`, `AU-2(d)`, `AU-3`, `AU-8(a)`, `AU-8(b)`, `AU-8(1)(a)`, `AU-8(1)(b)`, `AU-12(a)`, `AU-12(b)`, `AU-12©`, `CA-7(d)`, `SI-4(a)`, `SI-4(b)`, and `SI-4(c)` | The rule is removed. |
...
| `rule-da567ec9-8e24-4c65-993b-ad290bfdb855`	| Check whether Cloud Object Storage buckets are enabled with IBM Activity Tracker | `SC-11`, `SC-13`, `SC-23`, `CM-7(b)`, `SC-7(4)(C)`, `SC-8`, and `SC-8(1)` | The rule was	added. |
