...
# Change log: {[fs-cloud]} profile
{: #fs-change-log}

In this change log, you can learn about the latest changes, improvements, and updates for the {[fs-cloud]} profile. The change log lists changes that were made, ordered by the version number.
...
{: caption="Table. Active versions of the {[fs-cloud]} profile" caption-side="top"}
...
The following rules were updated in the {[fs-cloud]} library and profile as of 23 September 2023.

The name of the profile has been changed from {[cloud]} for Financial Services to {[fs-cloud]} as part of this release.
{: tip}
...
{: caption="Table. Summary of the changes for version 1.5.0 of the {[fs-cloud]} profile" caption-side="top"}
...
The following rules were updated in the {[cloud]} for Financial Services library and profile as of 9 August 2023.
...
{: caption="Table. Summary of the changes for version 1.4.0 of the {[cloud]} for Financial Services profile" caption-side="top"}


## Version 1.3.0
{: #fs-cloud-v130}

The following rules were updated in the {[cloud]} for Financial Services library and profile as of 19 June 2023.
...
{: caption="Table. Summary of the changes for version 1.3.0 of the {[cloud]} for Financial Services profile" caption-side="top"}
...
The following rules were updated in the {[cloud]} for Financial Services library and profile as of 20 April 2023.
...
{: caption="Table. Summary of the changes for version 1.2.0 of the {[cloud]} for Financial Services profile" caption-side="top"}


## Version 1.1.0
{: #fs-cloud-v110}

Version 1.1.0 of the {[cloud]} for Financial Services profile has been updated to include all 565 controls that have been identified as required to ensure that you are compliant with the {[fs-cloud]} reference architecture. As part of that update we've introduced the concept of "Manual assessments". When results are returned, you will see a new status: `user_evaluation_required` - this indicates that the control must be evaluated manually by your organization as the control check is either not yet or cannot be automated.
...
The format of the {[cloud]} for Financial Services profile has been updated with the following changes. Review your configuration closely to ensure that the profile still meets your needs.
...
Starting with version 1.0.0 of the {[cloud]} for Financial Services profile, all new versions of the profile that become available will be compatible only with the updated service architecture. To upgrade your profile version, you must move to the new evaluation format. For more information, see [Getting started]({[link]}-getting-started).
{: important}
