...
Now available
:   As of 6 December 2023, few component-id assesments in the  NIST SP 800-53 (Security and Privacy Controls for Information Systems and Organizations) profile has changed.
...
The component-id of following assements from `container-eks` to `azure-resource`.
