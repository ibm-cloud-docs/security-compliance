...
To get started with templates, you can go to the **Menu icon** ![Actions icon](../icons/actions-icon-vertical.svg) **> Security and Compliance > Govern resources > Configure > Templates**, or check out the [API reference](/apidocs/security-compliance/config) to learn more about creating templates programmatically.
