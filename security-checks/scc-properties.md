...
{: caption="<prod>Table 1.</prod><staging>Table 2.</staging> Rule properties that are available for the Billing platform component" caption-side="bottom"}
...
{: caption="<prod>Table 2.</prod><staging>Table 3.</staging> Rule properties that are available for the Catalog Management platform component" caption-side="bottom"}
...
{: caption="<prod>Table 3.</prod><staging>Table 4.</staging> Rule properties that are available for Certificate Manager" caption-side="bottom"}
...
{: caption="<prod>Table 4.</prod><staging>Table 5.</staging> Rule properties that are available for Cloud Object Storage" caption-side="bottom"}
...
{: caption="<prod>Table 5.</prod><staging>Table 6.</staging> Rule properties for {{site.data.keyword.codeengineshort}}" caption-side="bottom"}
...
{: caption="<prod>Table 6.</prod><staging>Table 7.</staging> Rule properties that are available for Container Registry" caption-side="bottom"}
...
{: caption="<prod>Table 7.</prod><staging>Table 8.</staging> Rule properties that are available for Direct Link" caption-side="bottom"}
...
{: caption="<prod>Table 8.</prod><staging>Table 9.</staging> Rule properties that are available for Event Streams" caption-side="bottom"}
...
{: caption="<prod>Table 9.</prod><staging>Table 10.</staging> Rule properties that are available for Hyper Protect Crypto Services" caption-side="bottom"}
...
{: caption="<prod>Table 10.</prod><staging>Table 11.</staging> Rule properties that are available for Hyper Protect DBaaS for MongoDB" caption-side="bottom"}
...
{: caption="<prod>Table 11.</prod><staging>Table 12.</staging> Rule properties that are available for Hyper Protect DBaaS for PostgreSQL" caption-side="bottom"}
...
{: caption="<prod>Table 12.</prod><staging>Table 13.</staging> Rule properties that are available for the IAM Access Groups platform component" caption-side="bottom"}
...
{: caption="<prod>Table 13.</prod><staging>Table 14.</staging> Rule properties that are available for the IAM Identity Service platform component" caption-side="bottom"}
...
{: caption="<prod>Table 14.</prod><staging>Table 15.</staging> Rule properties that are available for IBM Cloud Shell" caption-side="bottom"}
...
{: caption="<prod>Table 15.</prod><staging>Table 16.</staging>. Rule properties that are available for Cloud Internet Services" caption-side="bottom"}
...
{: caption="<prod>Table 16.</prod><staging>Table 17.</staging> Rule properties that are available for Key Protect" caption-side="bottom"}
...
{: caption="<prod>Table 17.</prod><staging>Table 18.</staging> Rule properties that are available for Load Balancer for VPC" caption-side="bottom"}
...
{: caption="<prod>Table 18.</prod><staging>Table 19.</staging> Rule properties that are available for ToolchainContinuous Delivery" caption-side="bottom"}
...
|:--------------|:---------|:--------------|:------------|
| `service` | `cross_account_connection_approved` | boolean | Indicates whether an incoming cross account connection request was approved. |
{: caption="<prod>Table 19.</prod><staging>Table 20.</staging> Rule properties that are available for Transit Gateway" caption-side="bottom"}
